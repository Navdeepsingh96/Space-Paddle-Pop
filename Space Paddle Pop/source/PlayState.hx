...
class PlayState extends FlxState
{
	...
	override public function create():Void
	{
		...
		scoreText.setFormat(null,15, FlxColor.LIME,"left");
		
		
		resetballText=new FlxText(0,FlxG.height/2, FlxG.width, "Resetting Ball ");
		resetballText.setFormat(null, 25, FlxColor.MAGENTA, "center");
		resetballText.visible = false;
		
		healthText=new FlxText(0,0, FlxG.width, "Health: "+ health);
		healthText.setFormat(null,15, FlxColor.LIME,"left");
		
		incomingText=new FlxText(0,20, FlxG.width, "Incoming!!!");
		incomingText.setFormat(null, 15, FlxColor.RED, "center");
		incomingText.visible = false;
		
		tileCountText=new FlxText(0,0, FlxG.width, "Tiles Remaining: "+tileCount);
		tileCountText.setFormat(null, 15, FlxColor.BLUE, "center");
		
		
		resetText=new FlxText(0,FlxG.height/2-50, FlxG.width, "RESTARTING...");
		resetText.setFormat(null,50, FlxColor.GREEN,"center");
		...
		leftWall.makeGraphic(10, FlxG.height-20, FlxColor.GRAY);
		leftWall.immovable = true;
		wallgroup.add(leftWall);
		
		rightWall = new FlxSprite(FlxG.width-10, 40);
		rightWall.makeGraphic(10, FlxG.height-20, FlxColor.GRAY);
		rightWall.immovable = true;
		wallgroup.add(rightWall);
		
		topWall = new FlxSprite(0, 40);
		topWall.makeGraphic(FlxG.width, 10, FlxColor.GRAY);
		topWall.immovable = true;
		wallgroup.add(topWall);
		
		bottomWall = new FlxSprite(0, FlxG.height-10);
		bottomWall.makeGraphic(FlxG.width, 10, FlxColor.RED);
		...
		var brickColours:Array<Int> = [0xff0a046d, 0xff140e7c, 0xff1c1689, 0xff2821a0, 0xff3b33c4, 0xff6d65f6];
